...
export default class AddResellerNitification extends Component {
  constructor (props) {
    super(props)
    this.state = {
      loader: false,
        ...
        <Row>
            <Col xl="12">
              <Card>
                  ...
                  <i className="fa fa-align-justify"></i> Add Notification{" "}
                <small className="text-muted">Form</small>
                <Link to="/res-notif-list" className="btn btn-sm btn-success feature-btn fa fa-list">&nbsp; Notification List</Link>
                  </CardHeader>
          <CardBody>
            {this.state.loader ? <Loader /> : ''}
