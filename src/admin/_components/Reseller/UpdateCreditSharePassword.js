...
export default class UpdateCreditSharePassword extends Component {
    constructor(props) {
    ...
    onFinish = values => {
        ...
        this.setState({ loader: true, showAlert: false }, () => {
            ...
            apiService
                .updateCreditSharePassword(formData)
                .then(addUserResponse => {
                    if (
                        ...
                        Modal.success({
                            ...
                            content: (
                              <div>
                                <p>Credit Share Password updated succesfully, Please logout and login again!</p>
                              </div>
                            ),
                            onOk() {},
                        });
        ...
        return (
            <Row>
                <Col xl='12'>
                    <Card>
                        <CardHeader>
                            <i className='fa fa-align-justify'>Update Credit Share Password</i>
                        </CardHeader>
                        <CardBody>
                            <Form
                                ref={this.formRef}
